...
export const ROUTE_CONFIG: RouteConfig[] = [
  ...
  { path: "/sdo/servicom/visits",         label: "Monitoring Visits",         module: "SDO",               functionality: "Monitoring Visits"         },
  { path: "/sdo/servicom/complaints",     label: "Complaints",                module: "SDO",               functionality: "Complaints"                },
